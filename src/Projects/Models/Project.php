...
class Project extends \Hubleto\Framework\Models\Model
{
  ...
  public function describeColumns(): array
  {
    return array_merge(parent::describeColumns(), [
      ...
      'identifier' => (new Varchar($this, $this->translate('Identifier')))->setProperty('defaultVisibility', true)->setRequired()->setCssClass('font-bold')->setDescription('Leave empty to generate automatically.'),
